                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" action="GET">
                        <?php foreach ($resLibro as $libros) {
                            ...
                            <tr id="body-header-static1" style="color:black; font-weight: bold; font-size:17px; height: 5.4rem; ">
                                ...
                                <input type="hidden" name="vendidos" id="vendidos" value="<?php echo $libros['vendidos_book'] ?>">
